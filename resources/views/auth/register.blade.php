...
@section('content')
    <form action="{{route('register')}}" method="POST" enctype="multipart/form-data">
        ...
        <div>
            ...
            <input id="password" type="password" name="password" placeholder="Введите пороль" required>
        </div>
        <div>
            <label for="password_confirmation">Подтвердите пароль</label>
            <input id="password_confirmation" type="password" name="password_confirmation" placeholder="Введите подтверждение пороля">
        </div>
        <div>
